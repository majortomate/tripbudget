...
function CreateDestination() {
  ...
  return (
    <>
      <button onClick={handleClick} className="block text-white bg-knowhere-dark-blue hover:bg-knowhere-dark-blue dark:bg-tripbudget-yellow dark:hover:bg-tripbudget-darker-yellow dark:text-black font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
        Add a Destination
      </button>
      <div>
