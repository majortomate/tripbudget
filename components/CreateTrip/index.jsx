  ...
  return (
    <div className="flex flex-col w-full">
      <div className="shadow overflow-hidden rounded md:rounded-lg space-y-6 bg-gray-50 px-4 py-5 sm:p-6 dark:bg-gray-800">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-3 gap-6 lg:grid-cols-7 md:grid-cols-3">
          ...
          <div className=" col-auto justify-self-center self-center">
            {!loading ? (
              <button
                type="submit"
                className="justify-center align-middle rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 disabled:bg-gray-300 disabled:text-black disabled:line-through"
              ...
              : (
                <button
                  type="submit"
                  className="justify-center align-middle rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700"
                >
        ...
        {currentTrip
          ? <TripCard currentTrip={currentTrip} /> : null}
