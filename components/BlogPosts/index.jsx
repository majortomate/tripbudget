  ...
  return (
    <section className="dark:bg-gray-800 dark:text-gray-100 bg-[url('/images/trip-vector-left.png')] bg-hero bg-no-repeat bg-contain bg-left-top sm:pb-80 lg:pb-20 pb-20 pt-32 sm:bg-contain lg:bg-auto" id="getInspired">
      <div className="lg:text-center mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto pb-12">
      ...
      <div className="container max-w-2xl p-6 mx-auto space-y-6 sm:space-y-12 lg:max-w-7xl">
        <a rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12  bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 bg-white">
          ...
          <a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 bg-white hidden sm:block">
