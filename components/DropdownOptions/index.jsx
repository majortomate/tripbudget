...
function DropdownOptions({ setHide }) {
  ...
  return (
    <div id="dropdown" className="z-10 w-44 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 absolute m-0 translate-y-0 translate-x-3 top-14">
      <ul className="py-1">
        <li>
          {!loading
            ? (
              <button onClick={handleClick} type="button" href="#" className="w-full flex items-center text-left py-2 px-4 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200">
            ...
            : (
              <button onClick={handleClick} type="button" href="#" className="w-full text-left block py-2 px-4 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
