  ...
  return (
    <div className="dark:bg-gray-900 relative gap-6">
      ...
      {profile
        ...
        : (
          <div className="flex  justify-center flex-col py-12 mx-auto max-w-screen-2xl h-screen">
            <p className="self-center text-5xl font-semibold whitespace-nowrap dark:text-white">You need to be logged in to access profile</p>
          </div>
        )}
